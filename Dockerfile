...
COPY rebrand.sh /usr/local/bin/rebrand.sh
# What a viewer reads in the tab. Nothing here names the product.
ARG APP_NAME=Console
RUN chmod 0755 /usr/local/bin/rebrand.sh && /usr/local/bin/rebrand.sh /app/dist
